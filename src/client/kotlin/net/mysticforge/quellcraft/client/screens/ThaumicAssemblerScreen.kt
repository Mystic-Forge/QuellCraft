...
class ThaumicAssemblerScreen(handler: ThaumicAssemblerScreenHandler, playerInventory: PlayerInventory, title: Text) :
    HandledScreen<ThaumicAssemblerScreenHandler>(handler, playerInventory, title) {
